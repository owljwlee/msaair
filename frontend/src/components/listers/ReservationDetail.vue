<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Number label="PeopleNo" v-model="item.peopleNo" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="MileageToIncrease" v-model="item.mileageToIncrease" :editMode="editMode" @change="change" />
            </div>
            <div>
